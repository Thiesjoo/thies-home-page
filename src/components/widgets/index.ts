...
export { default as Pauze } from "./Pauze.vue";
export { default as POS } from "./POS.vue";
export { default as Twitch } from "./TwitchFollow.vue";
...
export type ValidComponentNames = "Pauze" | "POS" | "Twitch" | "Spotify" | "Battery" | "Dummy";
